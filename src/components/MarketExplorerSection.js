      ...
      <RectangleParent>
        ...
        <FrameGroup>
          <ContainerCardFormFilter
            ...
            cryptoLogoUrl="Bitcoin"
            cryptoPairImageUrl="BTC/USDT"
            dimension="/vector4.svg"
            price="$25,776.80"
            cryptoIconUrl="https://coinmarketcap.com/currencies/bitcoin/#markets"
          ...
          <ContainerCardFormFilter
            ...
            cryptoLogoUrl="Ethereum"
            cryptoPairImageUrl="ETH/USDT"
            dimension="/vector4.svg"
            price="$1,607.11"
            cryptoIconUrl="https://coinmarketcap.com/currencies/ethereum/#markets"
            componentImageUrl="_blank"
            financialValue="$4.6B"
            percentage="12.1%"
            propHeight="28.3px"
